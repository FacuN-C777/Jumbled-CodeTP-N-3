...
export class HUDVersus extends Scene {
  ...
  create() {
    ...
    this.moneyPlayer1Text = this.add.text(20, 20, "Jugador 1: $0", {
      fontSize: "24px",
    ...
    this.moneyPlayer2Text = this.add.text(this.scale.width - 250, 20, "Jugador 2: $0", {
      fontSize: "24px",
    ...
    this.roundTimerText = this.add.text(this.scale.width / 2, 20, `Tiempo Restante: ${this.roundTimeLeft}`, {
      fontSize: "24px",
      color: "#028af8",
      fontFamily: '"Press Start 2P", monospace',
  ...
  updateMoney(player, count) {
    if (player === 1) {
      ...
      if (this.moneyPlayer1Text) this.moneyPlayer1Text.setText(`Jugador 1: $${this.moneyPlayer1}`);
    } else if (player === 2) {
      this.moneyPlayer2 = count;
      if (this.moneyPlayer2Text) this.moneyPlayer2Text.setText(`Jugador 2: $${this.moneyPlayer2}`);
    }
  }

  updateRoundTimer(count) {
    this.roundTimeLeft = count;
    if (this.roundTimerText) this.roundTimerText.setText(`Tiempo Restante: ${this.roundTimeLeft}`);
